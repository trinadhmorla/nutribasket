...
import com.trinadh.nutribasket.Adapter.HomeCategoryAdapter;
import com.trinadh.nutribasket.Adapter.RecommendedItemsAdapter;
import com.trinadh.nutribasket.Extras.GPSManager;
...
public class Home extends Fragment implements LocationListener {
    ...
    public void updateLocation() {
        ...
        if (isGPSEnabled) {
            ...
            GPSManager gps = new GPSManager((AppCompatActivity) getActivity());
            gps.start();
        }
